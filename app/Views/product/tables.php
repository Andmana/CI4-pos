                ...
                <table class="table table-sm table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td><?= $index++; ?></td>
                                <td style="text-align: center; vertical-align: middle;"><img src="<?= empty($row['image_product']) ? base_url('assets/upload/default-product.png') : base_url($row['image_product']); ?>" alt="Image Product" class="img-fluid" style="width: 100px;"></td>
